...
- Improvement: Upgraded mockito-core from 2.23.4 to 2.24.5, lf4j-api from 1.7.25 to 1.7.26, slf4j-log4j12 from 1.7.25 to 1.7.26, cassandra-driver-core from 3.6.0 to 3.7.0
