...
The number of lines (parameter -amount), the dimension (parameter -dimension), the size of each line (parameter -size) and the output file (parameter -outputfile) needs to be specified.
