...
## Download, Convert and Import data

```bash
wget http://download.geofabrik.de/europe/germany/berlin-latest.osm.pbf
cd $BBOXDB_HOME
$BBOXDB_HOME/bin/osm_data_conveter.sh -input /path/to/berlin-latest.osm.pbf -backend bdb -workfolder /diskb/work:/diskc/work:/diskd/work -output /path/to/outputdir/berlin
```
