...
### Package Envelope
This package encapsulates multiple other packaes in one request package. It can be used to compress more than one package at the time and to archive higher compression rates.
