...
The options determine the handling of the package. For example, the set bit 0x01 means that the tuple should be not inserted on disk (i.e., streaming tuple only).
