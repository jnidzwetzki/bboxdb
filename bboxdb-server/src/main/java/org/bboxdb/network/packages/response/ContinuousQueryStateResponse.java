...
public class ContinuousQueryStateResponse extends NetworkResponsePackage {
	 ...
	 */
	public static ContinuousQueryStateResponse decodePackage(final ByteBuffer encodedPackage) throws PackageEncodeException {		
