...
public class ContinuousQueryStateRequest extends NetworkRequestPacket {
	 ...
	 */
	public static ContinuousQueryStateRequest decodeTuple(final ByteBuffer encodedPackage) throws PacketEncodeException {
