...
public class NextPageRequest extends NetworkRequestPacket {
	 ...
	 */
	public static NextPageRequest decodeTuple(final ByteBuffer encodedPackage) throws PacketEncodeException {
