...
public class CreateDistributionGroupRequest extends NetworkRequestPacket {
	 ...
	 */
	public static CreateDistributionGroupRequest decodeTuple(final ByteBuffer encodedPackage) throws PacketEncodeException {
