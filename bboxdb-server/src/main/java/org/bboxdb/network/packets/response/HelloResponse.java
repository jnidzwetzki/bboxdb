...
public class HelloResponse extends NetworkResponsePacket {
	 ...
	 */
	public static HelloResponse decodePackage(final ByteBuffer encodedPackage) throws PacketEncodeException {		
