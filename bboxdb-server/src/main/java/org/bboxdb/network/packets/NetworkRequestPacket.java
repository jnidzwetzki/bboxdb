...
public abstract class NetworkRequestPacket extends NetworkPacket {
	...
	public NetworkRequestPacket(final short sequenceNumber, final RoutingHeader routingHeader) {
		super(sequenceNumber);
		this.routingHeader = Objects.requireNonNull(routingHeader);
	}

	public NetworkRequestPacket(final short sequenceNumber) {
