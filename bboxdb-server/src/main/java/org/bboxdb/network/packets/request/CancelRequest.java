...
public class CancelRequest extends NetworkRequestPacket {
	 ...
	 */
	public static CancelRequest decodeTuple(final ByteBuffer encodedPackage) throws PacketEncodeException {
