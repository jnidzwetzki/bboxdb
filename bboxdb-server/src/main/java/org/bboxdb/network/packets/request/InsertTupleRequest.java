...
public class InsertTupleRequest extends NetworkRequestPacket {
	 ...
	 */
	public static InsertTupleRequest decodeTuple(final ByteBuffer encodedPackage) throws IOException, PacketEncodeException {
