...
public class KeepAliveRequest extends NetworkRequestPacket {
	 ...
	 */
	public static KeepAliveRequest decodeTuple(final ByteBuffer encodedPackage) throws PacketEncodeException {
