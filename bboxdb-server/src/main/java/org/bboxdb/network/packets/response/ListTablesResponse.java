...
public class ListTablesResponse extends NetworkResponsePacket {
	 ...
	 */
	public static ListTablesResponse decodePackage(final ByteBuffer encodedPackage) throws PacketEncodeException {		
