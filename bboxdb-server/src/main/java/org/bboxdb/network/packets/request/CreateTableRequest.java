...
public class CreateTableRequest extends NetworkRequestPacket {
	 ...
	 */
	public static CreateTableRequest decodeTuple(final ByteBuffer encodedPackage) throws PacketEncodeException {
