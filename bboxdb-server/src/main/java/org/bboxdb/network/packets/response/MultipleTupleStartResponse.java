...
public class MultipleTupleStartResponse extends NetworkResponsePacket {
	 ...
	 */
	public static MultipleTupleStartResponse decodePackage(final ByteBuffer encodedPackage) throws PacketEncodeException {
		...
		return new MultipleTupleStartResponse(requestId);
	}
