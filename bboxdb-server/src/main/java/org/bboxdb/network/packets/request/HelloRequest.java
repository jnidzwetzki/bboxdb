...
public class HelloRequest extends NetworkRequestPacket {
	 ...
	 */
	public static HelloRequest decodeRequest(final ByteBuffer encodedPackage) throws PacketEncodeException {
