...
public class TestStorageManager {
	...
	public void testInsertElements1() throws Exception {
		final Tuple tuple = new Tuple("1", Hyperrectangle.FULL_SPACE, "abc".getBytes());
	...
	public void testInsertElements2() throws Exception {
		final Tuple tuple1 = new Tuple("1", Hyperrectangle.FULL_SPACE, "abc".getBytes());
		final Tuple tuple2 = new Tuple("1", Hyperrectangle.FULL_SPACE, "def".getBytes());
	...
	public void testInsertAndReadPerson() throws Exception {
		...
		final Tuple createdTuple = new Tuple("1", Hyperrectangle.FULL_SPACE, serializer.serialize(person1));
	...
	public void testStoreNullTuple() throws Exception {
		final Tuple createdTuple = new Tuple("1", Hyperrectangle.FULL_SPACE, null); // This should cause an NPE
		storageManager.put(createdTuple);
	...
	public void testBigInsert() throws Exception {
		...
		for(int i = 0; i < BIG_INSERT_TUPLES; i++) {
			final Tuple createdTuple = new Tuple(Integer.toString(i), Hyperrectangle.EMPTY_BOX, Integer.toString(i).getBytes());
			storageManager.put(createdTuple);
		}
	...
	public void testWithDuplicates() throws StorageManagerException, RejectedException {
		...
		final Tuple tuple1 = new Tuple("abc", Hyperrectangle.FULL_SPACE, "abc1".getBytes());
		storageManager.put(tuple1);
		
		final Tuple tuple2 = new Tuple("abc", Hyperrectangle.FULL_SPACE, "abc2".getBytes());
		storageManager.put(tuple2);

		final Tuple tuple3 = new Tuple("abc", Hyperrectangle.FULL_SPACE, "abc3".getBytes());
		storageManager.put(tuple3);

		final Tuple tuple4 = new Tuple("abc", Hyperrectangle.FULL_SPACE, "abc4".getBytes());
		storageManager.put(tuple4);

		final Tuple tuple5 = new Tuple("abc", Hyperrectangle.FULL_SPACE, "abc5".getBytes());
