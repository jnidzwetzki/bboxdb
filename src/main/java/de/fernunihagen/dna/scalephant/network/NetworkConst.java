...
public class NetworkConst {
	 ...
	 * Response type helo
	 */
	public static final byte RESPONSE_HELO = 0x00;
	 ...
	 */
	public static final byte RESPONSE_SUCCESS_WITH_BODY = 0x02;
	 ...
	 */
	public static final byte RESPONSE_ERROR_WITH_BODY = 0x04;
	
	/**
	 * Response of the list tables request
	 */
	public static final byte RESPONSE_LIST_TABLES = 0x05;
	
	/**
	 * Response that contains a single tuple
	 */
	public static final byte RESPONSE_TUPLE = 0x06;
	
	/**
	 * Start a multiple tuple result
	 */
	public static final byte RESPONSE_MULTIPLE_TUPLE_START = 0x07;
	
	/**
	 * End a multiple tuple result
	 */
	public static final byte RESPONSE_MULTIPLE_TUPLE_END = 0x08;
