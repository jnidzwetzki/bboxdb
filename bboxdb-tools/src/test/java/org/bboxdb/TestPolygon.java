...
public class TestPolygon {
	...
	public void testOSMEncoding() {
		...
		Assert.assertEquals(2, polygon.getBoundingBox(0.0).getDimension());
		Assert.assertTrue(polygon.getBoundingBox(0.0).getExtent(0) > 0);
		Assert.assertTrue(polygon.getBoundingBox(0.0).getExtent(1) > 0);
		
		Assert.assertEquals(polygon.getBoundingBox(0.0).getExtent(0) + 2.0, 
				polygon.getBoundingBox(1.0).getExtent(0), 0.001);
